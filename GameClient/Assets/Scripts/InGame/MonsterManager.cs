...
public class MonsterManager : MonoBehaviour
{
    ...
    public HashSet<EnemyController> chasingEnemies = new HashSet<EnemyController>();
    ...
    public int GetChasingMonsterCount()
    {
        return chasingEnemies != null ? chasingEnemies.Count : 0;
    }
}
