...
-----------------
1.8.6
- Fix items that come up with data that depends on the package data of the loaded unit.
- Modified package parsing logic
- Fixed input error in main scene

1.8.5
- Modified the old version package verification process.
- Fixed an issue where animations would reset when modifying units.

1.8.4
- Fixed parsing error for Prefab

1.8.3
- Modify add-on parsing script.

1.8.2
- Fix legacy Unity pivot dependency handling

1.8.1
- Fixed an error in the horse-related animation settings.
